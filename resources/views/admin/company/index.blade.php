  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="row">
        ...
        <!-- /.card-header -->
        <form action="/admin/company/store" method="POST" enctype="multipart/form-data">
          {{ csrf_field() }}
          <div class="card-body">
            ...
            <div class="form-group">
              ...
              {!! Form::number('phone1', null, ['class' => 'form-control','required'=>'true', 'placeholder'=>'Ingrese un número de teléfono']) !!}
            </div>
            <div class="form-group">
              <label for="exampleInputPhone2">Teléfono 2</label>
              {!! Form::number('phone2', null, ['class' => 'form-control','placeholder'=>'Ingrese un número de teléfono adicional']) !!}
            </div>  
            <div class="form-group">
              <label for="exampleInputEmail1">Email 1</label>
              {!! Form::email('email1', null, ['class' => 'form-control','required'=>'true','placeholder'=>'Ingrese un correo electrónico']) !!}
            </div>  
            <div class="form-group">
